...
static struct log_layout test_layout = { "test", &test_layout_type, NULL, true, true };
static struct log_appender test_appender = { "test", &test_appender_type, NULL, true, true };
...
/**
 * Test event (logger w/ already finalized appender and layout)
 */
TEST_CASE{
